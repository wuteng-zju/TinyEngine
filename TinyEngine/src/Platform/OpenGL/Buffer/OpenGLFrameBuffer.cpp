...
namespace
{
	...
	bool IsDepthFormat(FramebufferTextureFormat format)
	{
		switch (format)
		{
		case TinyEngine::FramebufferTextureFormat::DEPTH24_STENCIL8:
			return true;
		}
		return false;
	}
	...
	GLenum TextureFormatToGL(FramebufferTextureFormat format)
	{
		switch (format)
		{
		case TinyEngine::FramebufferTextureFormat::RED_INTERGER:
			return GL_RED_INTEGER;
		case TinyEngine::FramebufferTextureFormat::RGBA8:
			return GL_RGBA8;
		}
		return 0;
	}
	...
	FrameBuffer(spFrameBufferSpecification)
{
	...
	TINY_ENGINE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete");
