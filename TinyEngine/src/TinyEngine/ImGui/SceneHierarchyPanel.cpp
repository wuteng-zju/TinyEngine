	...
	DrawComponent<CameraComponent>("Camera", spEntity, [](auto& component)
		{
			...
			case TinyEngine::ProjectionType::Perspective:
			{
				...
				TINY_ENGINE_ASSERT(spPerspecCamera, "Perspectiv Graphic Camera is null in Scene Hierarchy Panel");
			...
			case TinyEngine::ProjectionType::Orthographic:
			{
				...
				TINY_ENGINE_ASSERT(spOrthoCamera, "Ortho Graphic Camera is null in Scene Hierarchy Panel");
