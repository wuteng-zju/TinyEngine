...
#include "TinyEngine/Debug/DrawStatistics/DrawStatistics.h"
#include "TinyEngine/Debug/DrawStatistics/QuadDrawStatics.h"
#include "TinyEngine/Debug/DrawStatistics/CircleDrawStatics.h"
#include "TinyEngine/Debug/DrawStatistics/LineDrawStatics.h"
...
void Render2D::Flush()
{
	...
	if (m_spRender2DStroge->spQuadDrawStatics->GetDrawCount())
	{
		...
		TINY_ENGINE_ASSERT(spQuadVertexBuffer, "QuadVertexBuffer is null in Render2D Draw line");
	...
	if (m_spRender2DStroge->spCircleDrawStatics->GetDrawCount())
	{
		...
		TINY_ENGINE_ASSERT(spCircleVertexBuffer, "CircleVertexBuffer is null in Render2D Draw line");
	...
	if (m_spRender2DStroge->spLineDrawStatics->GetDrawCount())
	{
		...
		TINY_ENGINE_ASSERT(spLineVertexBuffer, "LineVertexBuffer is null in Render2D Draw line");
